...
The Lepidoptera species use a set of wings, a forewing and hindwing for a plethora of survival functions such as movement, reproduction, and eating as well. These pairs of wings provide flight to all of these functions, and without them the species would not be able to transport themselves where necessary to survive. Like many species, their parts, such as these forewings and hindwings have evolved. 
	...
	There are many different reasons for evolutionary changes in wing shapes, such as varying competition levels in the ecology, or constraints due to the environment. Groups of species that live among many different species, especially predators, may experience low aspect ratio, whereas groups who are migrating frequently for varying reasons may have high aspect ratio. 
