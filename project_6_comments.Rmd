...
<div class="comment">
The figures above are results (minus the tree) and should go in this section. That is, describe the methods in the "methods" section and report the results with graphics and a narrative here.
```{r}
grade <-75
...
<div class="comment">
We need some text here, not just the rate numbers printed out.
```{r}
grade <-75
...
<div class="comment">
Isn't this hindwing PC1 vs forewing PC2? We needed just to compare PC2s between fore and hindwing.
```{r}
...
<div class="comment">
Super well done! Thanks for sticking this out and producing some very high-level analysis! Just need to remember to include a narrative for all your results. Congrats to you all!
```{r}
print(grade)
```
</div>
